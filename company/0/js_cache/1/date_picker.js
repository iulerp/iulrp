...
function CC(){var calendarId='CC';var currentYear=0;var currentMonth=0;var currentDay=0;var selectedYear=0;var selectedMonth=0;var selectedDay=0;var months=['Janeiro','Fevereiro','Março','Abril','Mai','Junho','Julho','Agosto','Setembro','Outubro','Novembro','Dezembro'];var wdays=['Dom','Seg','Ter','Qua','Qui','Sex','Sab'];var tmonths=['','Jan','Fev','Mar','Abr','Mai','Jun','Jul','Ago','Set','Out','Nov','Dez'];var dateField=null;function getProperty(p_property){var p_elm=calendarId;var elm=null;if(typeof(p_elm)=='object'){elm=p_elm;}else{elm=document.getElementById(p_elm);}
...
table+="</tr>";}
table+="<tr class='header'><th colspan='8' style='padding: 3px;text-align:center;'><a href='javascript:hideCC();'>Retroceder</a></td></tr>";table+="</table>";return table;}
