	...
	class renderer
	{
		...
		function menu_header($title, $no_menu, $is_index)
		{
			...
			echo "  <div id='iconlink'>";
	   		...
	   		if (!$no_menu) {
        		echo "    <a class='shortcut' href='$local_path_to_root/access/logout.php?'><img src='$local_path_to_root/themes/newwave/images/system-shutdown.png' title='"._("Logout")."' /></a>";
     		}
  			// Popup help
     		if ($help_base_url != null) {
			  echo "<a target = '_blank' onclick=" .'"'."javascript:openWindow(this.href,this.target); return false;".'" '. "href='". help_url()."'><img src='$local_path_to_root/themes/newwave/images/help-browser.png' title='"._("Help")."' /></a>";
